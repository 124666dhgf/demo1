...
export default function App() {
  ...
  const rows = [
    { id: 1, name: 'Anjaly', age: 36, is_manager: true, start_date: '02-28-1999' },
    { id: 2, name: 'Arun', age: 40, is_manager: true, start_date: '03-05-1997' },
    { id: 3, name: 'Sivangi', age: 39, is_manager: false, start_date: '07-12-2002' },
